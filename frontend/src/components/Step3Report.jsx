...
function Step3Report({ report }) {
  ...
  if (finalScore >= 8) {
    advice =
      "Excellent performance. Maintain confidence and structured answers.";
  } else if (finalScore >= 5) {
    advice =
      "Good foundation. Improve clarity, structure and provide stronger examples in answers.";
  } else {
    advice =
      "Significant improvement required. Focus on communication, confidence and structured thinking.";
  }
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-6">
      ...
      <div className='mb-8 flex flex-col sm:flex-row sm-items-center sm:justify-between gap-4'>
        ...
        className='h-14 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base whitespace-nowrap'>
          Download PDF
        </button>
