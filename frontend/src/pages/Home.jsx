...
import { delay, motion, time } from "motion/react";
import {
    BsRobot,
    BsClock,
    BsBarChart,
...
import evalImage from "../assets/ai-ans.png";
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-32">
                        <motion.h2
                            ...
                            className="text-4xl font-semibold text-center mb-16">Multiple Interview {" "}
                        ...
                        <div className="grid md:grid-cols-2 gap-10">
                            {
                                [
                                    ...
                                    },
                                    {
                                        ...
                                        desc: "Basic tone and voice analysis indsights"
                                    },
