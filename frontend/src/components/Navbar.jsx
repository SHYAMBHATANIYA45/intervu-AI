        ...
        <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
            <motion.div
                ...
                <div className='flex items-center gap-3 cursor-pointer'>
                    ...
                    <h1 className='font-semibold hidden md:block text-lg'>Intervu</h1>
                </div>
...
{showAuth && <AuthModel onClose={()=>setShowAuth()}></AuthModel>}
